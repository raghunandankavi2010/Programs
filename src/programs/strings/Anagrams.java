...
public class Anagrams {
    ...
    public static void main(String[] args) {
        ...
        //anagram2("abcf","cacdeg");
        //numberNeeded("abcf","ccdeg");
        numberNeeded2("abcf","ccdeg");
    }
 ...
 public static void anagram(String s1,String s2) {
    ...
    public static void numberNeeded(String first, String second) {
    ...
    public static void numberNeeded2(String one, String two){
